...
const xuiFormItemMapPosition = {
  ...
  setup(prop, { emit, attrs }) {
    ...
    // const { vals } = prop
    const MAPKEY = '2d5f833d35784c13ec8645f388066200'
    let MAP, markerBox
    ...
    const initMap = () => {
      ...
      function poiPickerReady(poiPicker) {
        ...
        poiPicker.on('poiPicked', function(poiResult) {
          ...
          // console.log('----------', poi);
          lnglatAddr.value = [poi.location.lng, poi.location.lat, addressStr.value]
    ...
    const confirm = () => {
      ...
      // cptMapPopover.value.showPopper = false;
      cptMapPopover.value?.hide();
    }
    const myCancel = () => {
      console.log(cptMapPopover.value)
      cptMapPopover.value?.hide();
    }
